...
export const leadershipExperienceDocuments = [
  ...
  toDocument(
    ...
    `Fall 2025 – Present: contract Web Developer for Holywatr (rock band brand platform, $2k+ project value). Built a \
  ...
  toDocument(
    ...
    `Bulldog Planner / Optimal Schedule Builder (UGA DevDogs — Google Developer Group at UGA, Aug 2024 – May 2025): \
