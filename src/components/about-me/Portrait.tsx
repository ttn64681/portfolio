...
export default function Portrait({ isTalking, showGlasses, onToggleGlasses }: PortraitProps) {
  ...
  const borderBoxClassName = `absolute left-1/2 -translate-x-1/2 top-[95px] w-[340px] h-[260px] p-[8px] ${
    hovered ? 'bg-gradient-to-b from-[#4dbdff] to-[#4dAF8F]' : 'bg-[#466C8C]'
  }`;
    ...
    <div className="w-full flex justify-center">
      <div className="profile-unit relative">
        ...
        <div className={borderBoxClassName}>
          <div className="w-9vh h-full bg-[#021728]" />
        </div>
