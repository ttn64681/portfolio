        ...
        <div className='experience-block__inner'>
          <header className='experience-block__header'>
            <div className='experience-block__title-wrap'>
              <h3 className='experience-block__title'>{exp.title}</h3>
              {exp.role && <p className='experience-block__role'>{exp.role}</p>}
            </div>
            {exp.date && (
              <span className='experience-block__date'>{exp.date}</span>
            )}
          </header>
          {exp.summary && (
            <p className='experience-block__summary'>{exp.summary}</p>
          )}
